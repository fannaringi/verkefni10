(function () {
	...
	*/
	...
	var API_KEY = 'x4xH9ZsI2Tgqu5adds4XrEI3WWKq7tEwXHbsTqvy'; // Slóð að sækja myndir frá. Dæmi um heila slóð https://api.nasa.gov/planetary/apod?api_key=DEMO_KEY&date=2019-11-10
	...
	function getRandomImage() {
	  var randomDate, requestURL, data, result;
	  return regeneratorRuntime.async(function getRandomImage$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          randomDate = new Date(randomNumber(Date.parse('16 Jun 1995'), Date.now()));
	          requestURL = "".concat(URL, "?api_key=").concat(API_KEY, "&date=").concat(randomDate.getFullYear(), "-").concat(randomDate.getMonth(), "-").concat(randomDate.getDay());
	...
	var LOCALSTORAGE_KEY = 'favourite_spacephotos';
	/**
	...
	function load() {
	  ...
	  for (var n = 1; n <= localStorage.length; n += 1) {
	    var mediaJSON = localStorage.getItem("".concat(LOCALSTORAGE_KEY, "-").concat(n));
	    var mediaObj = JSON.parse(mediaJSON);
	    var mediaItem = new Array(4);
	...
	function save(type, mediaUrl, text, title) {
	  var position = localStorage.length + 1;
	  var mediaJSON = "{\"type\": \"".concat(type, "\", \"mediaUrl\": \"").concat(mediaUrl, "\", \"text\": \"").concat(text, "\", \"title\": \"").concat(title, "\"}");
	  localStorage.setItem("".concat(LOCALSTORAGE_KEY, "-").concat(position), mediaJSON);
	  console.log('Media saved to favorites.');
	}

	var title; // titill fyrir mynd á forsíðu

	var text; // texti fyrir mynd á forsíðu

	var img; // mynd á forsíðu

	var videoURL; // url to video if any

	var image; // object sem inniheldur núverandi mynd á forsíðu.
	...
	function getNewImage() {
	  getRandomImage().then(function (data) {
	    if (data === null) {
	      ...
	      img = data.hdurl;
	      videoURL = data.url;
	      var apodNode = document.querySelector('.apod');
	      var titleNode = document.querySelector('.apod__title');
	      ...
	      if (data.media_type === 'image') {
	        ...
	        var vidDivNode = el('div');
	        vidDivNode.innerHTML = "<iframe width='560' height='315' src='".concat(videoURL, "' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>");
	...
	function loadFavourites() {
	  var savedMedia = load();
	  var appendNode = document.querySelector('h1');

	  for (var n = 0; n < savedMedia.length; n += 1) {
	    var titleNode = el('h2');
	    var titleText = savedMedia[n][3];
	    titleNode.innerHTML = titleText;
	    var mediaNode = void 0;
	    ...
	    if (savedMedia[n][0] === 'image') {
	      ...
	      mediaNode = el('div');
	      mediaNode.innerHTML = "<iframe width='560' height='315' src='".concat(savedMedia[n][1], "' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>");
	    }
